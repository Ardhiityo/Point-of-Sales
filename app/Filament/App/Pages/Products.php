...
{
    use HasPageShield, WithPagination, InteractsWithForms, InteractsWithActions;

    protected static string|BackedEnum|null $navigationIcon = Heroicon::ShoppingCart;

    protected string $view = 'filament.app.pages.products';
    ...
    {
        return view('filament.app.pages.header');
    }
            ...
            ->schema([
                Grid::make(2)
                    ->schema([
                        ...
                        Placeholder::make('denominations')->content(view('filament.app.components.dedominations')),
                    ])
            ])
            ->statePath('checkout');
    }
